...
namespace QuantityMeasurementApp.Business
{
    public interface IQuantityMeasurementService
    {
        ...
        IList<QuantityMeasurementEntity> GetAllMeasurements();
        IList<QuantityMeasurementEntity> GetMeasurementsByOperation(string operation);
        IList<QuantityMeasurementEntity> GetMeasurementsByType(string measurementType);
        int GetTotalCount();
    }
}