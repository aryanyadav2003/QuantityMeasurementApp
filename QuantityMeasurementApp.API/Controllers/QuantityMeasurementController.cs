...
namespace QuantityMeasurementApp.API.Controllers
{
    ...
    public class QuantityMeasurementController : ControllerBase
    {
        ...
        /// Handles all business logic for quantity measurement operations.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// 200 OK with <see cref="QuantityMeasurementDTO"/> containing the comparison result (true/false).
        ...
        /// <c>ThatQuantity</c> is not required for this operation.
        /// </param>
        /// <returns>
        ...
        /// Division by zero is handled and returns a 400 Bad Request.
        /// </summary>
        /// <remarks>
        /// Sample request:
        ///
        ...
        /// The operation type to filter by e.g. ADD, COMPARE, CONVERT, SUBTRACT, DIVIDE.
        /// Case-insensitive.
        /// </param>
        /// <returns>
        ...
        /// The measurement type to filter by e.g. LENGTH, WEIGHT, VOLUME, TEMPERATURE.
        /// Case-insensitive.
        /// </param>
        /// <returns>
        /// 200 OK with a filtered list of <see cref="QuantityMeasurementEntity"/> records.
        ...
        /// <summary>
        /// Returns the total count of all quantity measurement operations
        /// recorded since the application started.
        /// </summary>
        /// <remarks>
        /// Sample request:
        ///
